  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative h-[400px] w-full">
        <div className="absolute inset-0 bg-tcs-navy/70 z-10" />
        <div className="relative h-full w-full">
          <div className="absolute inset-0 bg-tcs-navy-700" />
          <div className="container mx-auto px-4 h-full flex items-center justify-center relative z-20">
            <div className="text-center text-white">
            <p className="text-center mb-2">
              <Link href="/blog" className="text-tcs-blue-300 hover:underline">
                ← Back to Blog
              </Link>
            </p>
              <h1 className="text-4xl font-bold text-center text-white">{post.title}</h1>
              <p className="mt-4 text-center text-tcs-blue-300">{post.date}</p>
            </div>
          </div>
        </div>
      </section>
